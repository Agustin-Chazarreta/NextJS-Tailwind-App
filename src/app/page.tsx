    ...
    <div className="h-full mb-24 mt-9">
      <div className="flex items-center justify-around h-full p-24 max-lg:flex-col max-lg:p-5">
        <div className="flex flex-col justify-center w-2/5 max-lg:w-full max-lg:text-center max-lg:relative order-2 max-lg:order-1">
          <div className={`text-sm mb-6 max-lg:mt-9${inter.className}`}>A B O U T — P E R S O N A L</div>
          <div className={`text-5xl mb-6 max-lg:text-3xl${inter.className}`}>¡Hello!<strong> I´m Angela Smith</strong> </div>
          <div className={`text-base mb-6 max-lg:mb-0${inter.className}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
